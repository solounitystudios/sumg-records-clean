...
import { getAllArtists, getPublishedReleases, getAllBrands, getAllProducers, getAllPublicSongSlugs } from "@/lib/cms";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/access`, lastModified: new Date(), priority: 0.5, changeFrequency: "yearly" },
  ];
